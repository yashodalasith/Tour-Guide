...
<body class="body2">
	...
	<center><div id="Feedback" class="tabcontent">
		...
		<form id="feedback" action="fb" method="post">
					...
					<table>
    					...
    					<c:forEach var="fee" items="${fbDetails}">
        				<tr>
            				<td>${fee.feedname}</td>
            				<td>${fee.feedback}</td>
            				<td>${fee.rating}</td>
	...
	<form id="fbdelete" action="FbDelete" method="post">
		<button type="submit" id="deletefeed" style="border-radius: 8px; border: none; background-color: red; color: white; padding: 12px 24px">Delete my responses</button>
    </form>
	
	<br><button class="list"><a href="home.jsp">Exit</a></button>
	</div></center>
      <div class="nav">
	  <center>
