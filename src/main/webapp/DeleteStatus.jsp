...
<body class="body2">
    ...
    <div class="tabcontent" style="height: 813px;">
		...
		%>
		<form action="deleteData" method="post" style="margin-top: 90px;">
			<p class="title"> Delete Details</p><br><br>
			Status ID <input type="text" name="statusid" value="<%= statusid %>" readonly><br><br>
	        Tour ID <input type="text" name="tour" value="<%= tour %>" readonly><br><br>
	        Accomodation <input type="text" name="accomodation" value="<%= accomodation %>" readonly><br><br>
	        Transport <input type="text" name="transport" value="<%= transport %>" readonly><br><br>
	        Itinerary <input type="text" name="itinerary" value="<%= itinerary %>" readonly><br><br>
	
	        <input type="submit" name="submit" value="Delete" style="margin-left: 430px;"><br>
	    </form>
		<br>
